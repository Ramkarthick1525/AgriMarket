...
const Aboutus = () => {
  ...
  <div className="max-w-4xl mx-auto text-center">
    <h2 className="text-4xl font-bold text-green-800 mb-4">About Farm Produce Hub</h2>
    <p className="text-lg text-gray-700 mb-8">
      <span className="font-semibold">Farm prouduce Hub</span> is your trusted online platform dedicated to connecting farmers, home producers, and eco-conscious buyers across India. We bring the richness of rural farming — organic, homemade, and sustainable products — directly to your home.
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-left text-gray-700">
      ...
      <div>
        <h3 className="text-xl font-semibold text-green-700 mb-2">🌿 Why Farm Produce Hub</h3>
    ...
    <p className="mt-10 text-md text-gray-600">
      At Farm Produce Hub, every purchase is a step toward a greener future and a stronger farming community. 🌱
    </p>
  </div>
</div>
